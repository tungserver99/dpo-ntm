...
def buubyyboo_dth(
    ...
    """
    Inverted Rank-Biased Overlap (IRBO) of top words. We called it BuuByyBoo.
    """
    if not top_words:
...
if __name__ == "__main__":
    # demo 6 topics, each topic has 15 words
    top_words: list[list[str]] = [
    ["apple", "banana", "orange", "grape", "kiwi",
     "mango", "pear", "peach", "pineapple", "strawberry",
     "blueberry", "raspberry", "cherry", "watermelon", "melon"],
    
    ["banana", "orange", "grape", "kiwi", "mango",
     "pear", "peach", "pineapple", "strawberry", "blueberry",
     "raspberry", "cherry", "watermelon", "melon", "apple"],
    
    ["orange", "grape", "kiwi", "mango", "pear",
     "peach", "pineapple", "strawberry", "blueberry", "raspberry",
     "cherry", "watermelon", "melon", "apple", "banana"],
    
    ["grape", "kiwi", "mango", "pear", "peach",
     "pineapple", "strawberry", "blueberry", "raspberry", "cherry",
     "watermelon", "melon", "apple", "banana", "orange"],
    
    ["kiwi", "mango", "pear", "peach", "pineapple",
    ...
    # calculate IRBO
    irbo_score = buubyyboo_dth(top_words, topk=15, weight=0.9)
    print(f"IRBO score: {irbo_score:.4f}")