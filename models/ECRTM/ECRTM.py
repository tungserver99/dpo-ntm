...
class ECRTM(nn.Module):
    ...
    def __init__(self, vocab_size, num_topics=50, en_units=200, dropout=0., 
                 pretrained_WE=None, train_WE=False, embed_size=200, beta_temp=0.2, 
                 weight_loss_ECR=100.0, sinkhorn_alpha=20.0, sinkhorn_max_iter=1000):
        super().__init__()
    ...
    def get_beta_logits(self):
        dist = self.pairwise_euclidean_distance(self.topic_embeddings, self.word_embeddings)
        logits = -dist / self.beta_temp
        return logits
