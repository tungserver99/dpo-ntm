...
class CTM(nn.Module):
    def __init__(self, vocab_size, contextual_emb_size, num_topics=50, en_units=200, dropout=0.4):
        super().__init__()
        ...
        self.fc11 = nn.Linear(vocab_size + contextual_emb_size, en_units)
    ...
    def forward(self, input, avg_loss=True, epoch_id=None):
        ...
        doc_input = torch.cat((bow, contextual_emb), dim=1)
        theta, mu, logvar = self.get_theta(doc_input)
